...
function App() {
  ...
  const vote = () => {
    ...
    let most = mostVotes;
    copy.forEach((value, idx) => {
      if (value > copy[most]) most = idx;
    });
  ...
  return (
    <>
      ...
      <Button text={"vote"} eventHandler={vote} />
      <Button text={"next anecdote"} eventHandler={getNext} />
